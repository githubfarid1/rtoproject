...
#---end
            ...
            with save_lock:
                ...
                for cidx, contact in enumerate(contactlist):
#-------------
...
#-----------
                    ...
                    contact_phone_w_ccode = '=IF(AU{0}="","",IF(AV{0}=6,AU{0},IF(AV{0}=8,CONCATENATE(IFS($BW{0}="NSW","+612",$BW{0}="ACT","+612",$BW{0}="VIC","+613",$BW{0}="TAS","+613",$BW{0}="QLD","+617",$BW{0}="WA","+618",$BW{0}="SA","+618",$BW{0}="NT","+618"),AU{0}),IF(AND(AV{0}=11,LEFT(AU{0},2)="61"),CONCATENATE("+",AU{0}),IF(LEFT(AU{0},3)="+64",AU{0},IF(OR(AV{0}=9,AV{0}=10),CONCATENATE("+61",AU{0})))))))'.format(str(rownum+cidx))
                    # breakpoint()
                    contact_fax_w_ccode =   '=IF(AZ{0}="","",IF(BA{0}=6,AZ{0},IF(BA{0}=8,CONCATENATE(IFS($BW{0}="NSW","+612",$BW{0}="ACT","+612",$BW{0}="VIC","+613",$BW{0}="TAS","+613",$BW{0}="QLD","+617",$BW{0}="WA","+618",$BW{0}="SA","+618",$BW{0}="NT","+618"),AZ{0}),IF(AND(BA{0}=11,LEFT(AZ{0},2)="61"),CONCATENATE("+",AZ{0}),IF(LEFT(AZ{0},3)="+64",AZ{0},IF(OR(BA{0}=9,BA{0}=10),CONCATENATE("+61",AZ{0})))))))'.format(rownum+cidx)
                    
                    contact_mobile_w_ccode = '=IF(BF{0}="","",IF(BG{0}=6,BF{0},IF(BG{0}=8,CONCATENATE(IFS($BW{0}="NSW","+612",$BW{0}="ACT","+612",$BW{0}="VIC","+613",$BW{0}="TAS","+613",$BW{0}="QLD","+617",$BW{0}="WA","+618",$BW{0}="SA","+618",$BW{0}="NT","+618"),BF{0}),IF(AND(BG{0}=11,LEFT(BF{0},2)="61"),CONCATENATE("+",BF{0}),IF(LEFT(BF{0},3)="+64",BF{0},IF(OR(BG{0}=9,BG{0}=10),CONCATENATE("+61",BF{0})))))))'.format(rownum+cidx)

                    sheet.cell(row=rownum+cidx, column=1).value = "RTO"
                    sheet.cell(row=rownum+cidx, column=2).value = code
                    sheet.cell(row=rownum+cidx, column=3).value = f"https://training.gov.au/Organisation/Details/{orgcode}"
                    sheet.cell(row=rownum+cidx, column=4).value = legal_name
                    sheet.cell(row=rownum+cidx, column=5).value = bname
                    sheet.cell(row=rownum+cidx, column=6).value =  status
                    sheet.cell(row=rownum+cidx, column=7).value =  abn
                    sheet.cell(row=rownum+cidx, column=8).value =     acn
                    sheet.cell(row=rownum+cidx, column=9).value =  rtype
                    sheet.cell(row=rownum+cidx, column=10).value =  website
                    sheet.cell(row=rownum+cidx, column=11).value =  regulator
                    sheet.cell(row=rownum+cidx, column=12).value =  regdate
                    sheet.cell(row=rownum+cidx, column=13).value =  regstart
                    sheet.cell(row=rownum+cidx, column=14).value =  regend
                    sheet.cell(row=rownum+cidx, column=15).value =  authority
                    sheet.cell(row=rownum+cidx, column=16).value =  excerciser
                    sheet.cell(row=rownum+cidx, column=17).value =   qual_codestr
                    sheet.cell(row=rownum+cidx, column=18).value =  qual_titlestr
                    sheet.cell(row=rownum+cidx, column=19).value =  unit_codestr
                    sheet.cell(row=rownum+cidx, column=20).value =  unit_titlestr
                    sheet.cell(row=rownum+cidx, column=21).value =  skill_codestr
                    sheet.cell(row=rownum+cidx, column=22).value = skill_titlestr
                    sheet.cell(row=rownum+cidx, column=23).value =  course_codestr
                    sheet.cell(row=rownum+cidx, column=24).value =  course_titlestr
                    sheet.cell(row=rownum+cidx, column=25).value =  head_ph1
                    sheet.cell(row=rownum+cidx, column=26).value =  head_ph2
                    sheet.cell(row=rownum+cidx, column=27).value =  head_pos1
                    sheet.cell(row=rownum+cidx, column=28).value =  head_pos2
                    sheet.cell(row=rownum+cidx, column=29).value =  ", ".join(regdec)
                    sheet.cell(row=rownum+cidx, column=30).value =  ", ".join(regefdate)
                    sheet.cell(row=rownum+cidx, column=31).value =  ", ".join(regendate)
                    sheet.cell(row=rownum+cidx, column=32).value =  ", ".join(regstat)
                    sheet.cell(row=rownum+cidx, column=33).value =  ", ".join(regrev)
                    sheet.cell(row=rownum+cidx, column=34).value =  contact_name
                    sheet.cell(row=rownum+cidx, column=35).value =  contact_job
                    sheet.cell(row=rownum+cidx, column=36).value =  contact_email
                    sheet.cell(row=rownum+cidx, column=37).value =  ""
                    sheet.cell(row=rownum+cidx, column=38).value =  contact_org
                    sheet.cell(row=rownum+cidx, column=39).value =  f"{contact_email} + {contact_org}"
                    sheet.cell(row=rownum+cidx, column=40).value =  contact_website
                    sheet.cell(row=rownum+cidx, column=41).value =  contact_email_no_add
                    sheet.cell(row=rownum+cidx, column=42).value =  contact_website_simp
                    sheet.cell(row=rownum+cidx, column=43).value =  contact_org
                    sheet.cell(row=rownum+cidx, column=44).value =  contact_email
                    sheet.cell(row=rownum+cidx, column=45).value =  ""
                    sheet.cell(row=rownum+cidx, column=46).value =  f"{contact_email} | "
                    sheet.cell(row=rownum+cidx, column=47).value =  contact_phone
                    sheet.cell(row=rownum+cidx, column=48).value =  f'=LEN(AU{rownum+cidx})'
                    sheet.cell(row=rownum+cidx, column=49).value =  contact_phone_w_ccode
                    sheet.cell(row=rownum+cidx, column=50).value =  f'=LEN(AW{rownum+cidx})'
                    sheet.cell(row=rownum+cidx, column=51).value =  f'=AW{rownum+cidx}'
                    sheet.cell(row=rownum+cidx, column=52).value =  contact_fax
                    sheet.cell(row=rownum+cidx, column=53).value =  f'=LEN(AZ{rownum+cidx})'
                    sheet.cell(row=rownum+cidx, column=54).value =  contact_fax_w_ccode
                    sheet.cell(row=rownum+cidx, column=55).value =  f'=LEN(BB{rownum+cidx})'
                    sheet.cell(row=rownum+cidx, column=56).value =  f'=BB{rownum+cidx}'
                    sheet.cell(row=rownum+cidx, column=57).value =  contact_mobile
                    sheet.cell(row=rownum+cidx, column=58).value =  contact_mobile_clean
                    sheet.cell(row=rownum+cidx, column=59).value =  f'=LEN(BF{rownum+cidx})'
                    sheet.cell(row=rownum+cidx, column=60).value =  contact_mobile_w_ccode
                    sheet.cell(row=rownum+cidx, column=61).value =  f'=LEN(BH{rownum+cidx})'
                    sheet.cell(row=rownum+cidx, column=62).value =  f'=BH{rownum+cidx}'
                    sheet.cell(row=rownum+cidx, column=63).value =  firstname
                    sheet.cell(row=rownum+cidx, column=64).value =  lastname
                    sheet.cell(row=rownum+cidx, column=65).value =  addressraw
                    sheet.cell(row=rownum+cidx, column=66).value =  addressraw_fr
                    sheet.cell(row=rownum+cidx, column=67).value =  addressraw1r
                    sheet.cell(row=rownum+cidx, column=68).value =  addressraw2r
                    sheet.cell(row=rownum+cidx, column=69).value =  addressraw3r
                    sheet.cell(row=rownum+cidx, column=70).value =  address1
                    sheet.cell(row=rownum+cidx, column=71).value =  postalcode
                    sheet.cell(row=rownum+cidx, column=72).value =  state
                    sheet.cell(row=rownum+cidx, column=73).value =  city
                    sheet.cell(row=rownum+cidx, column=74).value =  postalcode
                    sheet.cell(row=rownum+cidx, column=75).value =  state
                    sheet.cell(row=rownum+cidx, column=76).value =  address1
                    sheet.cell(row=rownum+cidx, column=77).value =  address1
                    sheet.cell(row=rownum+cidx, column=78).value =  headrawph
                    sheet.cell(row=rownum+cidx, column=79).value =  headrawph_fr
                    sheet.cell(row=rownum+cidx, column=80).value =  headrawphl1r
                    sheet.cell(row=rownum+cidx, column=81).value =  headrawphl2r
                    sheet.cell(row=rownum+cidx, column=82).value =  headrawphl3r
                    sheet.cell(row=rownum+cidx, column=83).value = '=IF(CB{0}="","",IF(CD{0}<>"",CONCATENATE(CB{0}," ",CC{0}),CB{0}))'.format(rownum+cidx)
                    sheet.cell(row=rownum+cidx, column=84).value = '=IF(CC{0}="","",IF(CD{0}<>"",CD{0},CC{0}))'.format(rownum+cidx)
                    sheet.cell(row=rownum+cidx, column=85).value =  headrawpos
                    sheet.cell(row=rownum+cidx, column=86).value =  headrawpos_fr
                    sheet.cell(row=rownum+cidx, column=87).value =  headrawposl1r
                    sheet.cell(row=rownum+cidx, column=88).value =  headrawposl2r
                    sheet.cell(row=rownum+cidx, column=89).value =  headrawposl3r
                    sheet.cell(row=rownum+cidx, column=90).value = '=IF(CI{0}="","",IF(CK{0}<>"",CONCATENATE(CI{0}," ",CJ{0}),CI{0}))'.format(rownum+cidx)
                    sheet.cell(row=rownum+cidx, column=91).value = '=IF(CJ{0}="","",IF(CK{0}<>"",CK{0},CJ{0}))'.format(rownum+cidx)
